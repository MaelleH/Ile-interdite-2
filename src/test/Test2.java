...
public class Test2 implements Observateur {
    ...
    public void initPartie(int nbj,int nivdif,ArrayList<String> nomJ){
        ...
        //Créer la grille
        grille = new Grille(2);      //Modifier dans la classe Grille pour avoir les differentes grilles
